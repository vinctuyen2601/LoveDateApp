          ...
          <>
            <View style={styles.sectionDivider}>
              ...
              <Text style={styles.sectionDividerText}>
                Nhãn sự kiện{" "}
                <Text style={styles.optionalLabel}>(Tuỳ chọn)</Text>
              </Text>
            </View>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.helperText}>
                Chọn một nhãn để phân loại sự kiện — app sẽ gợi ý quà và tạo
                checklist phù hợp
              </Text>
            </View>
          </>
                      ...
                      (dayShort, index) => (
                        <TouchableOpacity
                          ...
                          style={[
                            ...
                            dayOfWeek === index &&
                              styles.weekButtonInlineSelected,
                          ]}
                          onPress={() => {
                            setDayOfWeek(index);
        ...
        {(currentStep === 3 || isEditMode) && (
          <>
            <View style={styles.sectionDivider}>
              ...
              />
              <Text style={styles.sectionDividerText}>
                Nhắc nhở <Text style={styles.optionalLabel}>(Tuỳ chọn)</Text>
              </Text>
            </View>
